...
With the Path Write Protection plugin, write protection for paths can be set separately for each repository.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-pathwp-plugin/docs).
